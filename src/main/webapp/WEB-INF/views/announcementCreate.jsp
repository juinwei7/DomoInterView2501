...
<div class="container mt-5">
	...
	<form action="" method="post">
		...
		<div class="mb-3">
			...
			<input type="datetime-local" class="form-control" id="submitDate" name="submitDate" readonly>
		</div>

		<div class="mb-3">
			<label for="expireDate" class="form-label">截止日期：</label>
			<input type="datetime-local" class="form-control" id="expireDate" name="expireDate" required>
		</div>
