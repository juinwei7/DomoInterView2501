...
<div class="container mt-5">
	...
	<form action="" method="post">
		<div class="mb-3">
			<label for="id" class="form-label">公告編號：</label>
			<input type="text" class="form-control" id="id" name="id" value="${announcement.id}" readonly>
		</div>
		...
		<div class="mb-3">
			...
			<input type="datetime-local" class="form-control" id="expireDate" name="expireDate" value="${announcement.expireDate}" required>
		</div>

		<div class="mb-3">
			<label for="author" class="form-label">公佈者：</label>
			<input type="text" class="form-control" id="author" name="author" value="${announcement.author}" required>
		</div>
